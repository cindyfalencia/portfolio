...
export default function GithubRepoCard({repo, isDark}) {
  ...
  const hasForkCount = Number.isFinite(repo.node.forkCount);
  const starCount =
    repo.node.stargazers && Number.isFinite(repo.node.stargazers.totalCount)
      ? repo.node.stargazers.totalCount
      : null;
  const hasDiskUsage = Number.isFinite(repo.node.diskUsage);
        ...
        >
          ...
          <div className="repo-stats">
            <div className="repo-left-stat">
              ...
              {hasForkCount && repo.node.forkCount > 0 && (
                <span>
                  <svg
                    aria-hidden="true"
